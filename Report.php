...
class Report
{
    ...
    public function __construct(int $project_id, int $report_id, ExtendedReports $module) {
        $this->project_id = $project_id;
        $this->report_id = $report_id;
        $this->module = $module;
        $this->getExtendedAttributes($this->report_id);
    }
     ...
     */
    protected function getExtendedAttributes($report_id) {
